...
**The Shift:** *From Proprietary DSL $\rightarrow$ Pure TypeScript.*
...
**The Shift:** *From SQL-Construction $\rightarrow$ Declarative Data.*
...
**The Shift:** *From Managed Entities $\rightarrow$ Lean Results.*
...
- **The "Identity Map" Reflex**: If you are coming from MikroORM or Joist, remember: **UQL does not track state.** Changing `user.name = 'Bob'` does nothing to the database. You must explicitly call `updateOne`.
