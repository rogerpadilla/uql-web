...
In our [open benchmark](/benchmark) of pure SQL-generation speed, UQL is the fastest entry in all 8 query categories, on average **~2.1x** faster than the next fastest tool, including the standalone query builders Knex and Kysely.
