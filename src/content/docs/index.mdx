...
- **Fastest, even vs. query builders.** Fastest in [7 of 8 categories](/benchmark) of our [open benchmark](https://github.com/rogerpadilla/ts-orm-benchmark), tied with Knex on the 8th: ~2.1× faster on average than the runner-up, and quicker than raw builders like Knex and Kysely, reaching over 3.2M ops/s on simple SELECTs and DELETEs.
