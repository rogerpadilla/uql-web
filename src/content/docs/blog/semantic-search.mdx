...
description: "UQL 0.3 brings native vector similarity search to PostgreSQL, MariaDB, SQLite, and MongoDB Atlas through one type-safe query API — with zero-allocation overhead and automatic index migration for AI and RAG workloads."
date: 2026-03-12
authors:
  - rogerpadilla
tags:
