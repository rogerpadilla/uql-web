...
The full benchmark is open source and needs no database; it runs in seconds on Node.js. If your results differ, open an issue. The latest results always live on the [benchmark page](/benchmark), and there's a broader feature-by-feature comparison on the [comparison page](/comparison).
